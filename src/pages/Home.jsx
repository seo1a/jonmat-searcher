        ...
        <>
            <div>
                <div className="flex flex-col lg:flex-row mt-4 sm:mt-6 md:mt-8 lg:mt-12 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-52 gap-6 lg:gap-12">
                    ...
                    <div className="flex flex-col w-full lg:w-1/2 px-4 sm:px-6 md:px-8 lg:px-0 lg:ml-12 items-center md:items-start lg:max-w-[720px]">
                        <div className="flex space-x-3 sm:space-x-4 md:space-x-6 lg:space-x-8 w-full justify-center md:justify-start lg:ml-0">
